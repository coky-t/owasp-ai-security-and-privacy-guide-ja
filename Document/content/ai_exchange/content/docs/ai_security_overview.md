...
- **Threat model your system, to learn how to secure it**:  
   ...
   Alternatively, you can let our [THREAT MODEL AGENT](/go/threatmodelagent/) ask YOU questions about your system and threat model for you. Just go to the agent (requires a google account) and start by briefly describing your system. Your data will remain in your own google workspace.
- **Learn AI security**:  
...
There's an AI available that uses all this material to take you through the threat model process: [THREAT MODEL AGENT](/go/threatmodelagent/). Just go to the agent (requires a google account) and start by briefly describing your system. It will then interview you. Your data will remain in your own google workspace.
